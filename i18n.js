(function(){
  const EN={
    categories:["CONTRACTS","COPYRIGHT","SCHOOL & PRIVACY","DEFAMATION","ONLINE PRIVACY","RECORDING","SELF-DEFENSE","MINORS & CONTRACTS","LEGAL RIGHTS","STUDENT SPEECH"],
    scenarios:[
      ...
      "A public-school student criticizes a school policy on their own social-media account after school. The post contains no threat or incitement to violence, but the school considers it disrespectful.",
    ],
    questions:[
    ...
    options:[
      ...
      ["Educational use may support fair use, but it is not an automatic exemption; the purpose, nature, amount used, and market effect are considered.","Giving credit automatically gives you permission to use it.","Anything used for schoolwork is always fair use.","Students can never use copyrighted images in schoolwork."],
      ...
      ["It must be written rather than spoken.","You must prove that the speaker dislikes Alex.","You must prove that Alex did not respond that day.","The statement must be an objectively verifiable statement of fact rather than pure opinion."],
      ...
      ["Whether there was an imminent unlawful threat and whether the force used was reasonable and proportionate under the circumstances.","If the other person started it, any level of force afterward is automatically lawful.","Any action is allowed as long as you are afraid.","Self-defense applies only to criminal cases and can never affect civil liability."],
      ["Because minors are always treated as adults under U.S. law.","Once a minor has paid, they can never change their mind.","A contract is valid only if it is written on paper.","Minor-contract rules have exceptions and vary by state; many ordinary contracts may be voidable, but they cannot simply be called “always invalid.”"],
      ...
      ["School authority is limited by the First Amendment; the Supreme Court has said off-campus student speech generally receives stronger protection, although there are exceptions.","The school can always punish a student for criticizing the school.","The First Amendment never applies to students when they use social media.","Schools have exactly the same control over anything students say off campus as they do over speech at school."]
    ],
    explanations:[
      ...
      "<strong>Key point:</strong> In <em>Mahanoy Area School District v. B.L.</em>, the Supreme Court emphasized that schools generally have less authority over off-campus student speech. Threats, severe bullying, and other exceptional circumstances can require a different analysis."
    ],
    result:[
